...
const Profile = ({ user }) => {
  ...
  const defaultUser = {
    ...
    profileImage:
      "https://avatars.githubusercontent.com/u/139469612?s=400&u=53318d396bc1356a16ca061d0745e46f22313b38&v=4",
    coverImage:
  ...
  // Use the provided user data or default to the defaultUser object
  // but the user data is not used in the code so default user is activeted
      ...
      {historyTab === "flights" && (
        <>
          {[1, 2, 3].map((_, idx) => (
            <div
              key={idx}
              className="d-flex justify-content-between align-items-center border rounded p-3 mb-3 shadow-sm bg-white flex-wrap"
            >
              <div className="d-flex align-items-center mb-2 mb-md-0">
                <img
                  src="https://logos-world.net/wp-content/uploads/2020/03/Emirates-Logo-1999.jpg"
                  alt="Airline"
                  style={{ width: 60 }}
                  className="me-3"
                />
        ...
        <>
          {[1, 2].map((_, idx) => (
            ...
            >
              <div className="d-flex align-items-center mb-2 mb-md-0">
                <img
                  src="https://www.grandhotelsitea.it/wp-content/uploads/2024/07/Modello_Gif_ROYAL-1.png"
                  alt="Hotel"
                ...
                <div>
                  ...
                  <p className="mb-1 text-muted small">
                    Check-in: 14/12 • Check-out: 18/12
                  </p>
