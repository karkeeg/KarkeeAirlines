                ...
                <div className="position-relative" style={{ padding: "0px 30px" }}>
                    <div className="position-relative" style={{ maxHeight: '550px', overflow: 'hidden', borderRadius: "20px" }}>
                        <img
                            ...
                            style={{ objectFit: 'cover', objectPosition: 'center', transition: 'all 0.5s ease' }}
                            loading='lazy'
                        />

                        <div className="position-absolute top-0 start-0 p-4 text-white topic" style={{ maxWidth: '500px' }}>
                            <h1 className={`display-5 fw-light ${fade ? 'fade-in' : 'fade-out'}`}>{currentItem.heading1}</h1>
                            <h1 className={`display-3 fw-bold text-danger ${fade ? 'fade-in' : 'fade-out'}`}>{currentItem.heading2}</h1>
                            <p className={`mt-3 ${fade ? 'fade-in' : 'fade-out'}`}>{currentItem.description}</p>
                        </div>
                    </div>
                    ...
                    <div className="container position-relative" style={{ marginTop: '-90px', opacity: "0.9" }}>
                                    ...
                                    <form>
                                        <div className="row g-3">
                                            <div className="col-md-4">
                                                ...
                                                <input type="text" className="form-control" defaultValue="Kathmandu, Nepal" placeholder="Where are you going?" />
                                            </div>
                                            <div className="col-md-3">
