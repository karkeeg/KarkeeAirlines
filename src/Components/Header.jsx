...
const Header = () => {
  ...
  const [notifications, setNotifications] = useState([
    ...
    { id: 2, type: "info", message: "Your Trip is Confirmed.", read: false },
    {
      id: 3,
      type: "warning",
      message: "Special Discount for Members!",
      read: false,
    },
  ]);
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          ...
          {!loginAuth ? (
            <div className="d-flex">
              <Link to="/login">
                <button
                  className="btn me-2 hover-grow"
                  style={{ border: "1px solid #203553", color: "black" }}
                >
                  Login
                </button>
              </Link>
              <Link to="/signup">
                <button
                  ...
                  style={{ border: "1px solid #203553", background: "#203553" }}
                >
                  Register
                </button>
              </Link>
            ...
            <div className="d-flex align-items-center">
              {/* Notification Button */}
              <button
                className="btn notification-btn position-relative me-3"
